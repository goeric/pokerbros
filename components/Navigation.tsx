        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-3">
              <img src="/logo.svg" alt="PokerBros Logo" className="h-8 w-8" />
              <h1 className="text-2xl font-bold bg-gradient-to-r from-poker-green to-emerald-600 dark:from-poker-green dark:to-emerald-400 bg-clip-text text-transparent">
                PokerBros
              </h1>
            </Link>
          </div>
